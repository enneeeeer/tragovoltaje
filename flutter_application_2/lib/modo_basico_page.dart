...
class ModoBasicoPage extends StatefulWidget {
  const ModoBasicoPage({super.key});

  @override
  _ModoBasicoPageState createState() => _ModoBasicoPageState();
}

class _ModoBasicoPageState extends State<ModoBasicoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Bienvenido al Modo Basico'),
      ),
      body: Stack(
        children: [
          // Fondo GIF animado
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => RuletaJuegoPage(nombres: _nombres, modo: 'basico'),
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
